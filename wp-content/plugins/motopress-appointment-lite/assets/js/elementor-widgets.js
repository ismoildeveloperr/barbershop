(function (date, mpaData, intlTelInput) {
	...
	// Init shortcodes & widgets
	jQuery(window).on('load', () => {
	  if (window.elementorFrontend.isEditMode()) {
	    window.elementorFrontend.elements.$window.on('elementor/frontend/init', () => {
	      window.elementorFrontend.hooks.addAction('frontend/element_ready/appointment-form.default', $scope => {
	        const appointmentClass = $scope.find('.appointment-form-shortcode');
	        new AppointmentFormShortcode(appointmentClass);
	      });
	    });
	  }
	});
